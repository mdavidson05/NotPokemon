...
public class StartingMoves {
    ...
    private static final HashMap<PokemonTypes, ArrayList<Moves>> getStartingMoves(){
            ...
            //create moves
            Moves fireMove1 = new Moves("scratch",1,1,"normal",1,1,"normal");
            Moves fireMove2 = new Moves("tail whip",1,1,"normal",1,1,"normal");
            Moves fireMove3 = new Moves("ember", 1,1,"fire",1,1,"fire");
            Moves fireMove4 = new Moves("swift", 1,1,"normal",1,1,"normal");

            Moves waterMove1 = new Moves("scratch",1,1,"normal",1,1,"normal");
            Moves waterMove2 = new Moves("tail whip",1,1,"normal",1,1,"normal");
            Moves waterMove3 = new Moves("bubble", 1,1,"water",1,1,"water");
            Moves waterMove4 = new Moves("swift", 1,1,"normal",1,1,"normal");

            Moves grassMove1 = new Moves("scratch",1,1,"normal",1,1,"normal");
            Moves grassMove2 = new Moves("tail whip",1,1,"normal",1,1,"normal");
            Moves grassMove3 = new Moves("vine whip", 1,1,"grass",1,1,"grass");
            Moves grassMove4 = new Moves("swift", 1,1,"normal",1,1,"normal");
